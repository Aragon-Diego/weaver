...
const TareaHijo = (props) =>{
    ...
    return(
        <View style={{position:"relative"}} style={{opacity:.4,marginBottom:3,width:"90%",height:50,borderStyle:"solid",borderWidth:3,borderColor:"#9e9e9e", borderRadius: 5,flexWrap: 'wrap',alignItems: 'flex-start',flexDirection:'row'}}>
